...
- **رمزنگاری پساکوانتومی (PQC)**: توسط آژانس‌های امنیتی به عنوان یک اقدام مقابله‌ای توصیه می‌شود، اما همچنان نسبت به الگوریتم‌های کلاسیک کمتر اعتمادپذیر و کارآمد است.

- **توزیع کلید کوانتومی (QKD)**: از مکانیک کوانتومی برای
